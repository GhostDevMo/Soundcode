...
import com.soundcode.chat.model.constants.NetworkType;
...
public class SharedPreferencesManager {
    ...
    public static void setVibrateEnabled(Boolean vibrateEnabled) {
      mSharedPref.edit().putBoolean("notifications_new_message_vibrate", vibrateEnabled).apply();
    }
    ...
    public static void setRingtone(String uri) {
        mSharedPref.edit().putString("notifications_new_message_ringtone", uri).apply();
    }
    ...
    //check if user enabled notifications
    public static void setNotificationEnabled(Boolean aBoolean) {
        mSharedPref.edit().putBoolean("notifications_new_message", aBoolean).apply();
    }
