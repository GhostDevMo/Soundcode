...
public class com_soundcode_chat_model_realms_StatusRealmProxy extends com.soundcode.chat.model.realms.Status
    implements RealmObjectProxy, com_soundcode_chat_model_realms_StatusRealmProxyInterface {
    ...
    private ProxyState<com.soundcode.chat.model.realms.Status> proxyState;

    com_soundcode_chat_model_realms_StatusRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.soundcode.chat.model.realms.Status>(this);
    ...
    @SuppressWarnings("cast")
    public static com.soundcode.chat.model.realms.Status createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.soundcode.chat.model.realms.Status obj = null;
        if (update) {
            Table table = realm.getTable(com.soundcode.chat.model.realms.Status.class);
            StatusColumnInfo columnInfo = (StatusColumnInfo) realm.getSchema().getColumnInfo(com.soundcode.chat.model.realms.Status.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.soundcode.chat.model.realms.Status.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_soundcode_chat_model_realms_StatusRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            if (json.has("statusId")) {
                if (json.isNull("statusId")) {
                    obj = (io.realm.com_soundcode_chat_model_realms_StatusRealmProxy) realm.createObjectInternal(com.soundcode.chat.model.realms.Status.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_soundcode_chat_model_realms_StatusRealmProxy) realm.createObjectInternal(com.soundcode.chat.model.realms.Status.class, json.getString("statusId"), true, excludeFields);
                }
            } else {
        ...
        final com_soundcode_chat_model_realms_StatusRealmProxyInterface objProxy = (com_soundcode_chat_model_realms_StatusRealmProxyInterface) obj;
        if (json.has("userId")) {
    ...
    public static com.soundcode.chat.model.realms.Status createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.soundcode.chat.model.realms.Status obj = new com.soundcode.chat.model.realms.Status();
        final com_soundcode_chat_model_realms_StatusRealmProxyInterface objProxy = (com_soundcode_chat_model_realms_StatusRealmProxyInterface) obj;
        reader.beginObject();
    ...
    public static com.soundcode.chat.model.realms.Status copyOrUpdate(Realm realm, com.soundcode.chat.model.realms.Status object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.soundcode.chat.model.realms.Status) cachedRealmObject;
        }

        com.soundcode.chat.model.realms.Status realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.soundcode.chat.model.realms.Status.class);
            StatusColumnInfo columnInfo = (StatusColumnInfo) realm.getSchema().getColumnInfo(com.soundcode.chat.model.realms.Status.class);
            long pkColumnIndex = columnInfo.statusIdIndex;
            String value = ((com_soundcode_chat_model_realms_StatusRealmProxyInterface) object).realmGet$statusId();
            long rowIndex = Table.NO_MATCH;
            if (value == null) {
                rowIndex = table.findFirstNull(pkColumnIndex);
            } else {
            ...
            if (rowIndex == Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.soundcode.chat.model.realms.Status.class), false, Collections.<String> emptyList());
                    realmObject = new io.realm.com_soundcode_chat_model_realms_StatusRealmProxy();
    ...
    public static com.soundcode.chat.model.realms.Status copy(Realm realm, com.soundcode.chat.model.realms.Status newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.soundcode.chat.model.realms.Status realmObject = realm.createObjectInternal(com.soundcode.chat.model.realms.Status.class, ((com_soundcode_chat_model_realms_StatusRealmProxyInterface) newObject).realmGet$statusId(), false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_soundcode_chat_model_realms_StatusRealmProxyInterface realmObjectSource = (com_soundcode_chat_model_realms_StatusRealmProxyInterface) newObject;
        com_soundcode_chat_model_realms_StatusRealmProxyInterface realmObjectCopy = (com_soundcode_chat_model_realms_StatusRealmProxyInterface) realmObject;
    ...
    public static long insert(Realm realm, com.soundcode.chat.model.realms.Status object, Map<RealmModel,Long> cache) {
        ...
        StatusColumnInfo columnInfo = (StatusColumnInfo) realm.getSchema().getColumnInfo(com.soundcode.chat.model.realms.Status.class);
        long pkColumnIndex = columnInfo.statusIdIndex;
        String primaryKeyValue = ((com_soundcode_chat_model_realms_StatusRealmProxyInterface) object).realmGet$statusId();
        long rowIndex = Table.NO_MATCH;
        ...
        String realmGet$userId = ((com_soundcode_chat_model_realms_StatusRealmProxyInterface) object).realmGet$userId();
        if (realmGet$userId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.userIdIndex, rowIndex, realmGet$userId, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.timestampIndex, rowIndex, ((com_soundcode_chat_model_realms_StatusRealmProxyInterface) object).realmGet$timestamp(), false);
        String realmGet$thumbImg = ((com_soundcode_chat_model_realms_StatusRealmProxyInterface) object).realmGet$thumbImg();
        if (realmGet$thumbImg != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.thumbImgIndex, rowIndex, realmGet$thumbImg, false);
        }
        String realmGet$content = ((com_soundcode_chat_model_realms_StatusRealmProxyInterface) object).realmGet$content();
        if (realmGet$content != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.contentIndex, rowIndex, realmGet$content, false);
        }
        String realmGet$localPath = ((com_soundcode_chat_model_realms_StatusRealmProxyInterface) object).realmGet$localPath();
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.typeIndex, rowIndex, ((com_soundcode_chat_model_realms_StatusRealmProxyInterface) object).realmGet$type(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.durationIndex, rowIndex, ((com_soundcode_chat_model_realms_StatusRealmProxyInterface) object).realmGet$duration(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.seenCountIndex, rowIndex, ((com_soundcode_chat_model_realms_StatusRealmProxyInterface) object).realmGet$seenCount(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.seenCountSentIndex, rowIndex, ((com_soundcode_chat_model_realms_StatusRealmProxyInterface) object).realmGet$seenCountSent(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isSeenIndex, rowIndex, ((com_soundcode_chat_model_realms_StatusRealmProxyInterface) object).realmGet$isSeen(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        StatusColumnInfo columnInfo = (StatusColumnInfo) realm.getSchema().getColumnInfo(com.soundcode.chat.model.realms.Status.class);
        long pkColumnIndex = columnInfo.statusIdIndex;
        com.soundcode.chat.model.realms.Status object = null;
        while (objects.hasNext()) {
            object = (com.soundcode.chat.model.realms.Status) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.soundcode.chat.model.realms.Status object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.soundcode.chat.model.realms.Status.class);
    ...
    public static com.soundcode.chat.model.realms.Status createDetachedCopy(com.soundcode.chat.model.realms.Status realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.soundcode.chat.model.realms.Status unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.soundcode.chat.model.realms.Status();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.soundcode.chat.model.realms.Status) cachedObject.object;
            }
            unmanagedObject = (com.soundcode.chat.model.realms.Status) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_soundcode_chat_model_realms_StatusRealmProxyInterface unmanagedCopy = (com_soundcode_chat_model_realms_StatusRealmProxyInterface) unmanagedObject;
        com_soundcode_chat_model_realms_StatusRealmProxyInterface realmSource = (com_soundcode_chat_model_realms_StatusRealmProxyInterface) realmObject;
    ...
    static com.soundcode.chat.model.realms.Status update(Realm realm, com.soundcode.chat.model.realms.Status realmObject, com.soundcode.chat.model.realms.Status newObject, Map<RealmModel, RealmObjectProxy> cache) {
        com_soundcode_chat_model_realms_StatusRealmProxyInterface realmObjectTarget = (com_soundcode_chat_model_realms_StatusRealmProxyInterface) realmObject;
        com_soundcode_chat_model_realms_StatusRealmProxyInterface realmObjectSource = (com_soundcode_chat_model_realms_StatusRealmProxyInterface) newObject;
    ...
    public boolean equals(Object o) {
        ...
        com_soundcode_chat_model_realms_StatusRealmProxy aStatus = (com_soundcode_chat_model_realms_StatusRealmProxy)o;
