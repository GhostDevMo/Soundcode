...
public class com_soundcode_chat_model_realms_GroupRealmProxy extends com.soundcode.chat.model.realms.Group
    implements RealmObjectProxy, com_soundcode_chat_model_realms_GroupRealmProxyInterface {
    ...
    private ProxyState<com.soundcode.chat.model.realms.Group> proxyState;
    private RealmList<com.soundcode.chat.model.realms.User> usersRealmList;
    private RealmList<String> adminsUidsRealmList;

    com_soundcode_chat_model_realms_GroupRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.soundcode.chat.model.realms.Group>(this);
    ...
    @Override
    public RealmList<com.soundcode.chat.model.realms.User> realmGet$users() {
        proxyState.getRealm$realm().checkIfValid();
        ...
        if (usersRealmList != null) {
            ...
            usersRealmList = new RealmList<com.soundcode.chat.model.realms.User>(com.soundcode.chat.model.realms.User.class, osList, proxyState.getRealm$realm());
            return usersRealmList;
        }
    }

    @Override
    public void realmSet$users(RealmList<com.soundcode.chat.model.realms.User> value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
            ...
            if (value != null && !value.isManaged()) {
                ...
                final RealmList<com.soundcode.chat.model.realms.User> original = value;
                value = new RealmList<com.soundcode.chat.model.realms.User>();
                for (com.soundcode.chat.model.realms.User item : original) {
        ...
        if (value != null && value.size() == osList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                com.soundcode.chat.model.realms.User linkedObject = value.get(i);
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("Group", 7, 0);
    ...
    @SuppressWarnings("cast")
    public static com.soundcode.chat.model.realms.Group createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(2);
        com.soundcode.chat.model.realms.Group obj = null;
        if (update) {
            Table table = realm.getTable(com.soundcode.chat.model.realms.Group.class);
            GroupColumnInfo columnInfo = (GroupColumnInfo) realm.getSchema().getColumnInfo(com.soundcode.chat.model.realms.Group.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.soundcode.chat.model.realms.Group.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_soundcode_chat_model_realms_GroupRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            ...
            if (json.has("groupId")) {
                if (json.isNull("groupId")) {
                    obj = (io.realm.com_soundcode_chat_model_realms_GroupRealmProxy) realm.createObjectInternal(com.soundcode.chat.model.realms.Group.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_soundcode_chat_model_realms_GroupRealmProxy) realm.createObjectInternal(com.soundcode.chat.model.realms.Group.class, json.getString("groupId"), true, excludeFields);
                }
            } else {
        ...
        final com_soundcode_chat_model_realms_GroupRealmProxyInterface objProxy = (com_soundcode_chat_model_realms_GroupRealmProxyInterface) obj;
        ...
        if (json.has("users")) {
            if (json.isNull("users")) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    com.soundcode.chat.model.realms.User item = com_soundcode_chat_model_realms_UserRealmProxy.createOrUpdateUsingJsonObject(realm, array.getJSONObject(i), update);
    ...
    public static com.soundcode.chat.model.realms.Group createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.soundcode.chat.model.realms.Group obj = new com.soundcode.chat.model.realms.Group();
        final com_soundcode_chat_model_realms_GroupRealmProxyInterface objProxy = (com_soundcode_chat_model_realms_GroupRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    objProxy.realmSet$users(new RealmList<com.soundcode.chat.model.realms.User>());
                    reader.beginArray();
                    while (reader.hasNext()) {
                        com.soundcode.chat.model.realms.User item = com_soundcode_chat_model_realms_UserRealmProxy.createUsingJsonStream(realm, reader);
                        objProxy.realmGet$users().add(item);
                    }
                    reader.endArray();
                }
    ...
    public static com.soundcode.chat.model.realms.Group copyOrUpdate(Realm realm, com.soundcode.chat.model.realms.Group object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.soundcode.chat.model.realms.Group) cachedRealmObject;
        }

        com.soundcode.chat.model.realms.Group realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.soundcode.chat.model.realms.Group.class);
            GroupColumnInfo columnInfo = (GroupColumnInfo) realm.getSchema().getColumnInfo(com.soundcode.chat.model.realms.Group.class);
            long pkColumnIndex = columnInfo.groupIdIndex;
            String value = ((com_soundcode_chat_model_realms_GroupRealmProxyInterface) object).realmGet$groupId();
            long rowIndex = Table.NO_MATCH;
            if (value == null) {
                rowIndex = table.findFirstNull(pkColumnIndex);
            } else {
            ...
            if (rowIndex == Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.soundcode.chat.model.realms.Group.class), false, Collections.<String> emptyList());
                    realmObject = new io.realm.com_soundcode_chat_model_realms_GroupRealmProxy();
    ...
    public static com.soundcode.chat.model.realms.Group copy(Realm realm, com.soundcode.chat.model.realms.Group newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.soundcode.chat.model.realms.Group realmObject = realm.createObjectInternal(com.soundcode.chat.model.realms.Group.class, ((com_soundcode_chat_model_realms_GroupRealmProxyInterface) newObject).realmGet$groupId(), false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_soundcode_chat_model_realms_GroupRealmProxyInterface realmObjectSource = (com_soundcode_chat_model_realms_GroupRealmProxyInterface) newObject;
        com_soundcode_chat_model_realms_GroupRealmProxyInterface realmObjectCopy = (com_soundcode_chat_model_realms_GroupRealmProxyInterface) realmObject;
        ...
        RealmList<com.soundcode.chat.model.realms.User> usersList = realmObjectSource.realmGet$users();
        if (usersList != null) {
            RealmList<com.soundcode.chat.model.realms.User> usersRealmList = realmObjectCopy.realmGet$users();
            usersRealmList.clear();
            for (int i = 0; i < usersList.size(); i++) {
                com.soundcode.chat.model.realms.User usersItem = usersList.get(i);
                com.soundcode.chat.model.realms.User cacheusers = (com.soundcode.chat.model.realms.User) cache.get(usersItem);
                if (cacheusers != null) {
                    usersRealmList.add(cacheusers);
                } else {
                    usersRealmList.add(com_soundcode_chat_model_realms_UserRealmProxy.copyOrUpdate(realm, usersItem, update, cache));
                }
            }
        }
    ...
    public static long insert(Realm realm, com.soundcode.chat.model.realms.Group object, Map<RealmModel,Long> cache) {
        ...
        GroupColumnInfo columnInfo = (GroupColumnInfo) realm.getSchema().getColumnInfo(com.soundcode.chat.model.realms.Group.class);
        long pkColumnIndex = columnInfo.groupIdIndex;
        String primaryKeyValue = ((com_soundcode_chat_model_realms_GroupRealmProxyInterface) object).realmGet$groupId();
        long rowIndex = Table.NO_MATCH;
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isActiveIndex, rowIndex, ((com_soundcode_chat_model_realms_GroupRealmProxyInterface) object).realmGet$isActive(), false);
        String realmGet$createdByNumber = ((com_soundcode_chat_model_realms_GroupRealmProxyInterface) object).realmGet$createdByNumber();
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.timestampIndex, rowIndex, ((com_soundcode_chat_model_realms_GroupRealmProxyInterface) object).realmGet$timestamp(), false);

        RealmList<com.soundcode.chat.model.realms.User> usersList = ((com_soundcode_chat_model_realms_GroupRealmProxyInterface) object).realmGet$users();
        if (usersList != null) {
            OsList usersOsList = new OsList(table.getUncheckedRow(rowIndex), columnInfo.usersIndex);
            for (com.soundcode.chat.model.realms.User usersItem : usersList) {
                Long cacheItemIndexusers = cache.get(usersItem);
                if (cacheItemIndexusers == null) {
                    cacheItemIndexusers = com_soundcode_chat_model_realms_UserRealmProxy.insert(realm, usersItem, cache);
                }
                usersOsList.addRow(cacheItemIndexusers);
            }
        }

        RealmList<java.lang.String> adminsUidsList = ((com_soundcode_chat_model_realms_GroupRealmProxyInterface) object).realmGet$adminsUids();
        ...
        Table.nativeSetBoolean(tableNativePtr, columnInfo.onlyAdminsCanPostIndex, rowIndex, ((com_soundcode_chat_model_realms_GroupRealmProxyInterface) object).realmGet$onlyAdminsCanPost(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        GroupColumnInfo columnInfo = (GroupColumnInfo) realm.getSchema().getColumnInfo(com.soundcode.chat.model.realms.Group.class);
        long pkColumnIndex = columnInfo.groupIdIndex;
        com.soundcode.chat.model.realms.Group object = null;
        while (objects.hasNext()) {
            object = (com.soundcode.chat.model.realms.Group) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.soundcode.chat.model.realms.Group object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.soundcode.chat.model.realms.Group.class);
        ...
        if (usersList != null && usersList.size() == usersOsList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                ...
                Long cacheItemIndexusers = cache.get(usersItem);
                if (cacheItemIndexusers == null) {
                    cacheItemIndexusers = com_soundcode_chat_model_realms_UserRealmProxy.insertOrUpdate(realm, usersItem, cache);
                }
    ...
    public static com.soundcode.chat.model.realms.Group createDetachedCopy(com.soundcode.chat.model.realms.Group realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.soundcode.chat.model.realms.Group unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.soundcode.chat.model.realms.Group();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.soundcode.chat.model.realms.Group) cachedObject.object;
            }
            unmanagedObject = (com.soundcode.chat.model.realms.Group) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_soundcode_chat_model_realms_GroupRealmProxyInterface unmanagedCopy = (com_soundcode_chat_model_realms_GroupRealmProxyInterface) unmanagedObject;
        com_soundcode_chat_model_realms_GroupRealmProxyInterface realmSource = (com_soundcode_chat_model_realms_GroupRealmProxyInterface) realmObject;
        ...
        if (currentDepth == maxDepth) {
            ...
            RealmList<com.soundcode.chat.model.realms.User> managedusersList = realmSource.realmGet$users();
            RealmList<com.soundcode.chat.model.realms.User> unmanagedusersList = new RealmList<com.soundcode.chat.model.realms.User>();
            unmanagedCopy.realmSet$users(unmanagedusersList);
            int nextDepth = currentDepth + 1;
            int size = managedusersList.size();
            for (int i = 0; i < size; i++) {
                com.soundcode.chat.model.realms.User item = com_soundcode_chat_model_realms_UserRealmProxy.createDetachedCopy(managedusersList.get(i), nextDepth, maxDepth, cache);
    ...
    static com.soundcode.chat.model.realms.Group update(Realm realm, com.soundcode.chat.model.realms.Group realmObject, com.soundcode.chat.model.realms.Group newObject, Map<RealmModel, RealmObjectProxy> cache) {
        com_soundcode_chat_model_realms_GroupRealmProxyInterface realmObjectTarget = (com_soundcode_chat_model_realms_GroupRealmProxyInterface) realmObject;
        com_soundcode_chat_model_realms_GroupRealmProxyInterface realmObjectSource = (com_soundcode_chat_model_realms_GroupRealmProxyInterface) newObject;
        ...
        RealmList<com.soundcode.chat.model.realms.User> usersList = realmObjectSource.realmGet$users();
        RealmList<com.soundcode.chat.model.realms.User> usersRealmList = realmObjectTarget.realmGet$users();
        if (usersList != null && usersList.size() == usersRealmList.size()) {
            ...
            for (int i = 0; i < objects; i++) {
                ...
                if (cacheusers != null) {
                    ...
                    usersRealmList.set(i, com_soundcode_chat_model_realms_UserRealmProxy.copyOrUpdate(realm, usersItem, true, cache));
                }
            }
        } else {
            usersRealmList.clear();
            if (usersList != null) {
                for (int i = 0; i < usersList.size(); i++) {
                    ...
                    if (cacheusers != null) {
                        ...
                        usersRealmList.add(com_soundcode_chat_model_realms_UserRealmProxy.copyOrUpdate(realm, usersItem, true, cache));
                    }
                }
            }
        }
    ...
    public boolean equals(Object o) {
        ...
        com_soundcode_chat_model_realms_GroupRealmProxy aGroup = (com_soundcode_chat_model_realms_GroupRealmProxy)o;
