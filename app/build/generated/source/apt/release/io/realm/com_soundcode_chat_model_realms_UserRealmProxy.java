...
public class com_soundcode_chat_model_realms_UserRealmProxy extends com.soundcode.chat.model.realms.User
    implements RealmObjectProxy, com_soundcode_chat_model_realms_UserRealmProxyInterface {
    ...
    private ProxyState<com.soundcode.chat.model.realms.User> proxyState;

    com_soundcode_chat_model_realms_UserRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.soundcode.chat.model.realms.User>(this);
    ...
    @Override
    public com.soundcode.chat.model.realms.Group realmGet$group() {
        proxyState.getRealm$realm().checkIfValid();
        if (proxyState.getRow$realm().isNullLink(columnInfo.groupIndex)) {
            return null;
        }
        return proxyState.getRealm$realm().get(com.soundcode.chat.model.realms.Group.class, proxyState.getRow$realm().getLink(columnInfo.groupIndex), false, Collections.<String>emptyList());
    }

    @Override
    public void realmSet$group(com.soundcode.chat.model.realms.Group value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
    ...
    @SuppressWarnings("cast")
    public static com.soundcode.chat.model.realms.User createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(1);
        com.soundcode.chat.model.realms.User obj = null;
        if (update) {
            Table table = realm.getTable(com.soundcode.chat.model.realms.User.class);
            UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.soundcode.chat.model.realms.User.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.soundcode.chat.model.realms.User.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_soundcode_chat_model_realms_UserRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            ...
            if (json.has("uid")) {
                if (json.isNull("uid")) {
                    obj = (io.realm.com_soundcode_chat_model_realms_UserRealmProxy) realm.createObjectInternal(com.soundcode.chat.model.realms.User.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_soundcode_chat_model_realms_UserRealmProxy) realm.createObjectInternal(com.soundcode.chat.model.realms.User.class, json.getString("uid"), true, excludeFields);
                }
            } else {
        ...
        final com_soundcode_chat_model_realms_UserRealmProxyInterface objProxy = (com_soundcode_chat_model_realms_UserRealmProxyInterface) obj;
        if (json.has("photo")) {
        ...
        if (json.has("group")) {
            if (json.isNull("group")) {
                ...
                com.soundcode.chat.model.realms.Group groupObj = com_soundcode_chat_model_realms_GroupRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("group"), update);
    ...
    public static com.soundcode.chat.model.realms.User createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.soundcode.chat.model.realms.User obj = new com.soundcode.chat.model.realms.User();
        final com_soundcode_chat_model_realms_UserRealmProxyInterface objProxy = (com_soundcode_chat_model_realms_UserRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.soundcode.chat.model.realms.Group groupObj = com_soundcode_chat_model_realms_GroupRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$group(groupObj);
                }
    ...
    public static com.soundcode.chat.model.realms.User copyOrUpdate(Realm realm, com.soundcode.chat.model.realms.User object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.soundcode.chat.model.realms.User) cachedRealmObject;
        }

        com.soundcode.chat.model.realms.User realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.soundcode.chat.model.realms.User.class);
            UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.soundcode.chat.model.realms.User.class);
            long pkColumnIndex = columnInfo.uidIndex;
            String value = ((com_soundcode_chat_model_realms_UserRealmProxyInterface) object).realmGet$uid();
            long rowIndex = Table.NO_MATCH;
            if (value == null) {
                rowIndex = table.findFirstNull(pkColumnIndex);
            } else {
            ...
            if (rowIndex == Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.soundcode.chat.model.realms.User.class), false, Collections.<String> emptyList());
                    realmObject = new io.realm.com_soundcode_chat_model_realms_UserRealmProxy();
    ...
    public static com.soundcode.chat.model.realms.User copy(Realm realm, com.soundcode.chat.model.realms.User newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.soundcode.chat.model.realms.User realmObject = realm.createObjectInternal(com.soundcode.chat.model.realms.User.class, ((com_soundcode_chat_model_realms_UserRealmProxyInterface) newObject).realmGet$uid(), false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_soundcode_chat_model_realms_UserRealmProxyInterface realmObjectSource = (com_soundcode_chat_model_realms_UserRealmProxyInterface) newObject;
        com_soundcode_chat_model_realms_UserRealmProxyInterface realmObjectCopy = (com_soundcode_chat_model_realms_UserRealmProxyInterface) realmObject;
        ...
        com.soundcode.chat.model.realms.Group groupObj = realmObjectSource.realmGet$group();
        if (groupObj == null) {
            realmObjectCopy.realmSet$group(null);
        } else {
            com.soundcode.chat.model.realms.Group cachegroup = (com.soundcode.chat.model.realms.Group) cache.get(groupObj);
            if (cachegroup != null) {
                realmObjectCopy.realmSet$group(cachegroup);
            } else {
                realmObjectCopy.realmSet$group(com_soundcode_chat_model_realms_GroupRealmProxy.copyOrUpdate(realm, groupObj, update, cache));
            }
        }
    ...
    public static long insert(Realm realm, com.soundcode.chat.model.realms.User object, Map<RealmModel,Long> cache) {
        ...
        UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.soundcode.chat.model.realms.User.class);
        long pkColumnIndex = columnInfo.uidIndex;
        String primaryKeyValue = ((com_soundcode_chat_model_realms_UserRealmProxyInterface) object).realmGet$uid();
        long rowIndex = Table.NO_MATCH;
        ...
        String realmGet$photo = ((com_soundcode_chat_model_realms_UserRealmProxyInterface) object).realmGet$photo();
        if (realmGet$photo != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.photoIndex, rowIndex, realmGet$photo, false);
        }
        String realmGet$status = ((com_soundcode_chat_model_realms_UserRealmProxyInterface) object).realmGet$status();
        if (realmGet$status != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.statusIndex, rowIndex, realmGet$status, false);
        }
        String realmGet$phone = ((com_soundcode_chat_model_realms_UserRealmProxyInterface) object).realmGet$phone();
        if (realmGet$phone != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.phoneIndex, rowIndex, realmGet$phone, false);
        }
        String realmGet$userLocalPhoto = ((com_soundcode_chat_model_realms_UserRealmProxyInterface) object).realmGet$userLocalPhoto();
        ...
        String realmGet$userName = ((com_soundcode_chat_model_realms_UserRealmProxyInterface) object).realmGet$userName();
        if (realmGet$userName != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.userNameIndex, rowIndex, realmGet$userName, false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isBlockedIndex, rowIndex, ((com_soundcode_chat_model_realms_UserRealmProxyInterface) object).realmGet$isBlocked(), false);
        String realmGet$appVer = ((com_soundcode_chat_model_realms_UserRealmProxyInterface) object).realmGet$appVer();
        if (realmGet$appVer != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.appVerIndex, rowIndex, realmGet$appVer, false);
        }
        String realmGet$thumbImg = ((com_soundcode_chat_model_realms_UserRealmProxyInterface) object).realmGet$thumbImg();
        if (realmGet$thumbImg != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.thumbImgIndex, rowIndex, realmGet$thumbImg, false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isGroupBoolIndex, rowIndex, ((com_soundcode_chat_model_realms_UserRealmProxyInterface) object).realmGet$isGroupBool(), false);

        com.soundcode.chat.model.realms.Group groupObj = ((com_soundcode_chat_model_realms_UserRealmProxyInterface) object).realmGet$group();
        if (groupObj != null) {
            Long cachegroup = cache.get(groupObj);
            if (cachegroup == null) {
                cachegroup = com_soundcode_chat_model_realms_GroupRealmProxy.insert(realm, groupObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.groupIndex, rowIndex, cachegroup, false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isStoredInContactsIndex, rowIndex, ((com_soundcode_chat_model_realms_UserRealmProxyInterface) object).realmGet$isStoredInContacts(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        UserColumnInfo columnInfo = (UserColumnInfo) realm.getSchema().getColumnInfo(com.soundcode.chat.model.realms.User.class);
        long pkColumnIndex = columnInfo.uidIndex;
        com.soundcode.chat.model.realms.User object = null;
        while (objects.hasNext()) {
            object = (com.soundcode.chat.model.realms.User) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.soundcode.chat.model.realms.User object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.soundcode.chat.model.realms.User.class);
        ...
        if (groupObj != null) {
            Long cachegroup = cache.get(groupObj);
            if (cachegroup == null) {
                cachegroup = com_soundcode_chat_model_realms_GroupRealmProxy.insertOrUpdate(realm, groupObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.groupIndex, rowIndex, cachegroup, false);
        } else {
    ...
    public static com.soundcode.chat.model.realms.User createDetachedCopy(com.soundcode.chat.model.realms.User realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.soundcode.chat.model.realms.User unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.soundcode.chat.model.realms.User();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.soundcode.chat.model.realms.User) cachedObject.object;
            }
            unmanagedObject = (com.soundcode.chat.model.realms.User) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_soundcode_chat_model_realms_UserRealmProxyInterface unmanagedCopy = (com_soundcode_chat_model_realms_UserRealmProxyInterface) unmanagedObject;
        com_soundcode_chat_model_realms_UserRealmProxyInterface realmSource = (com_soundcode_chat_model_realms_UserRealmProxyInterface) realmObject;
        ...
        // Deep copy of group
        unmanagedCopy.realmSet$group(com_soundcode_chat_model_realms_GroupRealmProxy.createDetachedCopy(realmSource.realmGet$group(), currentDepth + 1, maxDepth, cache));
        unmanagedCopy.realmSet$isStoredInContacts(realmSource.realmGet$isStoredInContacts());

        return unmanagedObject;
    }

    static com.soundcode.chat.model.realms.User update(Realm realm, com.soundcode.chat.model.realms.User realmObject, com.soundcode.chat.model.realms.User newObject, Map<RealmModel, RealmObjectProxy> cache) {
        com_soundcode_chat_model_realms_UserRealmProxyInterface realmObjectTarget = (com_soundcode_chat_model_realms_UserRealmProxyInterface) realmObject;
        com_soundcode_chat_model_realms_UserRealmProxyInterface realmObjectSource = (com_soundcode_chat_model_realms_UserRealmProxyInterface) newObject;
        ...
        if (groupObj == null) {
            ...
            if (cachegroup != null) {
                ...
                realmObjectTarget.realmSet$group(com_soundcode_chat_model_realms_GroupRealmProxy.copyOrUpdate(realm, groupObj, true, cache));
            }
        }
