...
public class com_soundcode_chat_model_realms_MessageRealmProxy extends com.soundcode.chat.model.realms.Message
    implements RealmObjectProxy, com_soundcode_chat_model_realms_MessageRealmProxyInterface {
    ...
    private ProxyState<com.soundcode.chat.model.realms.Message> proxyState;

    com_soundcode_chat_model_realms_MessageRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.soundcode.chat.model.realms.Message>(this);
    ...
    @Override
    public com.soundcode.chat.model.realms.RealmContact realmGet$contact() {
        proxyState.getRealm$realm().checkIfValid();
        if (proxyState.getRow$realm().isNullLink(columnInfo.contactIndex)) {
            return null;
        }
        return proxyState.getRealm$realm().get(com.soundcode.chat.model.realms.RealmContact.class, proxyState.getRow$realm().getLink(columnInfo.contactIndex), false, Collections.<String>emptyList());
    }

    @Override
    public void realmSet$contact(com.soundcode.chat.model.realms.RealmContact value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
    ...
    @Override
    public com.soundcode.chat.model.realms.RealmLocation realmGet$location() {
        proxyState.getRealm$realm().checkIfValid();
        if (proxyState.getRow$realm().isNullLink(columnInfo.locationIndex)) {
            return null;
        }
        return proxyState.getRealm$realm().get(com.soundcode.chat.model.realms.RealmLocation.class, proxyState.getRow$realm().getLink(columnInfo.locationIndex), false, Collections.<String>emptyList());
    }

    @Override
    public void realmSet$location(com.soundcode.chat.model.realms.RealmLocation value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
    ...
    @Override
    public com.soundcode.chat.model.realms.QuotedMessage realmGet$quotedMessage() {
        proxyState.getRealm$realm().checkIfValid();
        if (proxyState.getRow$realm().isNullLink(columnInfo.quotedMessageIndex)) {
            return null;
        }
        return proxyState.getRealm$realm().get(com.soundcode.chat.model.realms.QuotedMessage.class, proxyState.getRow$realm().getLink(columnInfo.quotedMessageIndex), false, Collections.<String>emptyList());
    }

    @Override
    public void realmSet$quotedMessage(com.soundcode.chat.model.realms.QuotedMessage value) {
        if (proxyState.isUnderConstruction()) {
            if (!proxyState.getAcceptDefaultValue$realm()) {
                return;
            }
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("Message", 23, 0);
    ...
    @SuppressWarnings("cast")
    public static com.soundcode.chat.model.realms.Message createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = new ArrayList<String>(3);
        com.soundcode.chat.model.realms.Message obj = null;
        if (update) {
            Table table = realm.getTable(com.soundcode.chat.model.realms.Message.class);
            MessageColumnInfo columnInfo = (MessageColumnInfo) realm.getSchema().getColumnInfo(com.soundcode.chat.model.realms.Message.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.soundcode.chat.model.realms.Message.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_soundcode_chat_model_realms_MessageRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            ...
            if (json.has("messageId")) {
                if (json.isNull("messageId")) {
                    obj = (io.realm.com_soundcode_chat_model_realms_MessageRealmProxy) realm.createObjectInternal(com.soundcode.chat.model.realms.Message.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_soundcode_chat_model_realms_MessageRealmProxy) realm.createObjectInternal(com.soundcode.chat.model.realms.Message.class, json.getString("messageId"), true, excludeFields);
                }
            } else {
        ...
        final com_soundcode_chat_model_realms_MessageRealmProxyInterface objProxy = (com_soundcode_chat_model_realms_MessageRealmProxyInterface) obj;
        if (json.has("fromId")) {
        ...
        if (json.has("contact")) {
            if (json.isNull("contact")) {
                ...
                com.soundcode.chat.model.realms.RealmContact contactObj = com_soundcode_chat_model_realms_RealmContactRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("contact"), update);
        ...
        if (json.has("location")) {
            if (json.isNull("location")) {
                ...
                com.soundcode.chat.model.realms.RealmLocation locationObj = com_soundcode_chat_model_realms_RealmLocationRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("location"), update);
        ...
        if (json.has("quotedMessage")) {
            if (json.isNull("quotedMessage")) {
                ...
                com.soundcode.chat.model.realms.QuotedMessage quotedMessageObj = com_soundcode_chat_model_realms_QuotedMessageRealmProxy.createOrUpdateUsingJsonObject(realm, json.getJSONObject("quotedMessage"), update);
    ...
    public static com.soundcode.chat.model.realms.Message createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.soundcode.chat.model.realms.Message obj = new com.soundcode.chat.model.realms.Message();
        final com_soundcode_chat_model_realms_MessageRealmProxyInterface objProxy = (com_soundcode_chat_model_realms_MessageRealmProxyInterface) obj;
        reader.beginObject();
        while (reader.hasNext()) {
            ...
            if (false) {
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.soundcode.chat.model.realms.RealmContact contactObj = com_soundcode_chat_model_realms_RealmContactRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$contact(contactObj);
                }
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.soundcode.chat.model.realms.RealmLocation locationObj = com_soundcode_chat_model_realms_RealmLocationRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$location(locationObj);
                }
                ...
                if (reader.peek() == JsonToken.NULL) {
                    ...
                    com.soundcode.chat.model.realms.QuotedMessage quotedMessageObj = com_soundcode_chat_model_realms_QuotedMessageRealmProxy.createUsingJsonStream(realm, reader);
                    objProxy.realmSet$quotedMessage(quotedMessageObj);
                }
            } else {
                reader.skipValue();
    ...
    public static com.soundcode.chat.model.realms.Message copyOrUpdate(Realm realm, com.soundcode.chat.model.realms.Message object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.soundcode.chat.model.realms.Message) cachedRealmObject;
        }

        com.soundcode.chat.model.realms.Message realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.soundcode.chat.model.realms.Message.class);
            MessageColumnInfo columnInfo = (MessageColumnInfo) realm.getSchema().getColumnInfo(com.soundcode.chat.model.realms.Message.class);
            long pkColumnIndex = columnInfo.messageIdIndex;
            String value = ((com_soundcode_chat_model_realms_MessageRealmProxyInterface) object).realmGet$messageId();
            long rowIndex = Table.NO_MATCH;
            if (value == null) {
                rowIndex = table.findFirstNull(pkColumnIndex);
            } else {
            ...
            if (rowIndex == Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.soundcode.chat.model.realms.Message.class), false, Collections.<String> emptyList());
                    realmObject = new io.realm.com_soundcode_chat_model_realms_MessageRealmProxy();
    ...
    public static com.soundcode.chat.model.realms.Message copy(Realm realm, com.soundcode.chat.model.realms.Message newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        com.soundcode.chat.model.realms.Message realmObject = realm.createObjectInternal(com.soundcode.chat.model.realms.Message.class, ((com_soundcode_chat_model_realms_MessageRealmProxyInterface) newObject).realmGet$messageId(), false, Collections.<String>emptyList());
        cache.put(newObject, (RealmObjectProxy) realmObject);

        com_soundcode_chat_model_realms_MessageRealmProxyInterface realmObjectSource = (com_soundcode_chat_model_realms_MessageRealmProxyInterface) newObject;
        com_soundcode_chat_model_realms_MessageRealmProxyInterface realmObjectCopy = (com_soundcode_chat_model_realms_MessageRealmProxyInterface) realmObject;
        ...
        com.soundcode.chat.model.realms.RealmContact contactObj = realmObjectSource.realmGet$contact();
        if (contactObj == null) {
            realmObjectCopy.realmSet$contact(null);
        } else {
            com.soundcode.chat.model.realms.RealmContact cachecontact = (com.soundcode.chat.model.realms.RealmContact) cache.get(contactObj);
            if (cachecontact != null) {
                realmObjectCopy.realmSet$contact(cachecontact);
            } else {
                realmObjectCopy.realmSet$contact(com_soundcode_chat_model_realms_RealmContactRealmProxy.copyOrUpdate(realm, contactObj, update, cache));
            }
        }

        com.soundcode.chat.model.realms.RealmLocation locationObj = realmObjectSource.realmGet$location();
        if (locationObj == null) {
            realmObjectCopy.realmSet$location(null);
        } else {
            com.soundcode.chat.model.realms.RealmLocation cachelocation = (com.soundcode.chat.model.realms.RealmLocation) cache.get(locationObj);
            if (cachelocation != null) {
                realmObjectCopy.realmSet$location(cachelocation);
            } else {
                realmObjectCopy.realmSet$location(com_soundcode_chat_model_realms_RealmLocationRealmProxy.copyOrUpdate(realm, locationObj, update, cache));
            }
        }
        ...
        com.soundcode.chat.model.realms.QuotedMessage quotedMessageObj = realmObjectSource.realmGet$quotedMessage();
        if (quotedMessageObj == null) {
            realmObjectCopy.realmSet$quotedMessage(null);
        } else {
            com.soundcode.chat.model.realms.QuotedMessage cachequotedMessage = (com.soundcode.chat.model.realms.QuotedMessage) cache.get(quotedMessageObj);
            if (cachequotedMessage != null) {
                realmObjectCopy.realmSet$quotedMessage(cachequotedMessage);
            } else {
                realmObjectCopy.realmSet$quotedMessage(com_soundcode_chat_model_realms_QuotedMessageRealmProxy.copyOrUpdate(realm, quotedMessageObj, update, cache));
            }
        }
        return realmObject;
    }

    public static long insert(Realm realm, com.soundcode.chat.model.realms.Message object, Map<RealmModel,Long> cache) {
        ...
        MessageColumnInfo columnInfo = (MessageColumnInfo) realm.getSchema().getColumnInfo(com.soundcode.chat.model.realms.Message.class);
        long pkColumnIndex = columnInfo.messageIdIndex;
        String primaryKeyValue = ((com_soundcode_chat_model_realms_MessageRealmProxyInterface) object).realmGet$messageId();
        long rowIndex = Table.NO_MATCH;
        ...
        String realmGet$fromId = ((com_soundcode_chat_model_realms_MessageRealmProxyInterface) object).realmGet$fromId();
        if (realmGet$fromId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.fromIdIndex, rowIndex, realmGet$fromId, false);
        }
        String realmGet$fromPhone = ((com_soundcode_chat_model_realms_MessageRealmProxyInterface) object).realmGet$fromPhone();
        ...
        String realmGet$toId = ((com_soundcode_chat_model_realms_MessageRealmProxyInterface) object).realmGet$toId();
        if (realmGet$toId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.toIdIndex, rowIndex, realmGet$toId, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.typeIndex, rowIndex, ((com_soundcode_chat_model_realms_MessageRealmProxyInterface) object).realmGet$type(), false);
        String realmGet$content = ((com_soundcode_chat_model_realms_MessageRealmProxyInterface) object).realmGet$content();
        if (realmGet$content != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.contentIndex, rowIndex, realmGet$content, false);
        }
        String realmGet$timestamp = ((com_soundcode_chat_model_realms_MessageRealmProxyInterface) object).realmGet$timestamp();
        if (realmGet$timestamp != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.timestampIndex, rowIndex, realmGet$timestamp, false);
        }
        String realmGet$chatId = ((com_soundcode_chat_model_realms_MessageRealmProxyInterface) object).realmGet$chatId();
        if (realmGet$chatId != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.chatIdIndex, rowIndex, realmGet$chatId, false);
        }
        Table.nativeSetLong(tableNativePtr, columnInfo.messageStatIndex, rowIndex, ((com_soundcode_chat_model_realms_MessageRealmProxyInterface) object).realmGet$messageStat(), false);
        String realmGet$localPath = ((com_soundcode_chat_model_realms_MessageRealmProxyInterface) object).realmGet$localPath();
        ...
        Table.nativeSetLong(tableNativePtr, columnInfo.downloadUploadStatIndex, rowIndex, ((com_soundcode_chat_model_realms_MessageRealmProxyInterface) object).realmGet$downloadUploadStat(), false);
        String realmGet$metadata = ((com_soundcode_chat_model_realms_MessageRealmProxyInterface) object).realmGet$metadata();
        if (realmGet$metadata != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.metadataIndex, rowIndex, realmGet$metadata, false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.voiceMessageSeenIndex, rowIndex, ((com_soundcode_chat_model_realms_MessageRealmProxyInterface) object).realmGet$voiceMessageSeen(), false);
        String realmGet$mediaDuration = ((com_soundcode_chat_model_realms_MessageRealmProxyInterface) object).realmGet$mediaDuration();
        ...
        String realmGet$thumb = ((com_soundcode_chat_model_realms_MessageRealmProxyInterface) object).realmGet$thumb();
        if (realmGet$thumb != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.thumbIndex, rowIndex, realmGet$thumb, false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isForwardedIndex, rowIndex, ((com_soundcode_chat_model_realms_MessageRealmProxyInterface) object).realmGet$isForwarded(), false);
        String realmGet$videoThumb = ((com_soundcode_chat_model_realms_MessageRealmProxyInterface) object).realmGet$videoThumb();
        ...
        String realmGet$fileSize = ((com_soundcode_chat_model_realms_MessageRealmProxyInterface) object).realmGet$fileSize();
        if (realmGet$fileSize != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.fileSizeIndex, rowIndex, realmGet$fileSize, false);
        }

        com.soundcode.chat.model.realms.RealmContact contactObj = ((com_soundcode_chat_model_realms_MessageRealmProxyInterface) object).realmGet$contact();
        if (contactObj != null) {
            Long cachecontact = cache.get(contactObj);
            if (cachecontact == null) {
                cachecontact = com_soundcode_chat_model_realms_RealmContactRealmProxy.insert(realm, contactObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.contactIndex, rowIndex, cachecontact, false);
        }

        com.soundcode.chat.model.realms.RealmLocation locationObj = ((com_soundcode_chat_model_realms_MessageRealmProxyInterface) object).realmGet$location();
        if (locationObj != null) {
            Long cachelocation = cache.get(locationObj);
            if (cachelocation == null) {
                cachelocation = com_soundcode_chat_model_realms_RealmLocationRealmProxy.insert(realm, locationObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.locationIndex, rowIndex, cachelocation, false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isGroupIndex, rowIndex, ((com_soundcode_chat_model_realms_MessageRealmProxyInterface) object).realmGet$isGroup(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isSeenIndex, rowIndex, ((com_soundcode_chat_model_realms_MessageRealmProxyInterface) object).realmGet$isSeen(), false);

        com.soundcode.chat.model.realms.QuotedMessage quotedMessageObj = ((com_soundcode_chat_model_realms_MessageRealmProxyInterface) object).realmGet$quotedMessage();
        if (quotedMessageObj != null) {
            Long cachequotedMessage = cache.get(quotedMessageObj);
            if (cachequotedMessage == null) {
                cachequotedMessage = com_soundcode_chat_model_realms_QuotedMessageRealmProxy.insert(realm, quotedMessageObj, cache);
            }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        MessageColumnInfo columnInfo = (MessageColumnInfo) realm.getSchema().getColumnInfo(com.soundcode.chat.model.realms.Message.class);
        long pkColumnIndex = columnInfo.messageIdIndex;
        com.soundcode.chat.model.realms.Message object = null;
        while (objects.hasNext()) {
            object = (com.soundcode.chat.model.realms.Message) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.soundcode.chat.model.realms.Message object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.soundcode.chat.model.realms.Message.class);
        ...
        if (contactObj != null) {
            Long cachecontact = cache.get(contactObj);
            if (cachecontact == null) {
                cachecontact = com_soundcode_chat_model_realms_RealmContactRealmProxy.insertOrUpdate(realm, contactObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.contactIndex, rowIndex, cachecontact, false);
        } else {
        ...
        if (locationObj != null) {
            Long cachelocation = cache.get(locationObj);
            if (cachelocation == null) {
                cachelocation = com_soundcode_chat_model_realms_RealmLocationRealmProxy.insertOrUpdate(realm, locationObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.locationIndex, rowIndex, cachelocation, false);
        } else {
        ...
        if (quotedMessageObj != null) {
            Long cachequotedMessage = cache.get(quotedMessageObj);
            if (cachequotedMessage == null) {
                cachequotedMessage = com_soundcode_chat_model_realms_QuotedMessageRealmProxy.insertOrUpdate(realm, quotedMessageObj, cache);
            }
            Table.nativeSetLink(tableNativePtr, columnInfo.quotedMessageIndex, rowIndex, cachequotedMessage, false);
        } else {
    ...
    public static com.soundcode.chat.model.realms.Message createDetachedCopy(com.soundcode.chat.model.realms.Message realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.soundcode.chat.model.realms.Message unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.soundcode.chat.model.realms.Message();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.soundcode.chat.model.realms.Message) cachedObject.object;
            }
            unmanagedObject = (com.soundcode.chat.model.realms.Message) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_soundcode_chat_model_realms_MessageRealmProxyInterface unmanagedCopy = (com_soundcode_chat_model_realms_MessageRealmProxyInterface) unmanagedObject;
        com_soundcode_chat_model_realms_MessageRealmProxyInterface realmSource = (com_soundcode_chat_model_realms_MessageRealmProxyInterface) realmObject;
        ...
        unmanagedCopy.realmSet$contact(com_soundcode_chat_model_realms_RealmContactRealmProxy.createDetachedCopy(realmSource.realmGet$contact(), currentDepth + 1, maxDepth, cache));

        // Deep copy of location
        unmanagedCopy.realmSet$location(com_soundcode_chat_model_realms_RealmLocationRealmProxy.createDetachedCopy(realmSource.realmGet$location(), currentDepth + 1, maxDepth, cache));
        ...
        unmanagedCopy.realmSet$quotedMessage(com_soundcode_chat_model_realms_QuotedMessageRealmProxy.createDetachedCopy(realmSource.realmGet$quotedMessage(), currentDepth + 1, maxDepth, cache));

        return unmanagedObject;
    }

    static com.soundcode.chat.model.realms.Message update(Realm realm, com.soundcode.chat.model.realms.Message realmObject, com.soundcode.chat.model.realms.Message newObject, Map<RealmModel, RealmObjectProxy> cache) {
        com_soundcode_chat_model_realms_MessageRealmProxyInterface realmObjectTarget = (com_soundcode_chat_model_realms_MessageRealmProxyInterface) realmObject;
        com_soundcode_chat_model_realms_MessageRealmProxyInterface realmObjectSource = (com_soundcode_chat_model_realms_MessageRealmProxyInterface) newObject;
        realmObjectTarget.realmSet$fromId(realmObjectSource.realmGet$fromId());
        realmObjectTarget.realmSet$fromPhone(realmObjectSource.realmGet$fromPhone());
        realmObjectTarget.realmSet$toId(realmObjectSource.realmGet$toId());
        ...
        realmObjectTarget.realmSet$chatId(realmObjectSource.realmGet$chatId());
        realmObjectTarget.realmSet$messageStat(realmObjectSource.realmGet$messageStat());
        realmObjectTarget.realmSet$localPath(realmObjectSource.realmGet$localPath());
        realmObjectTarget.realmSet$downloadUploadStat(realmObjectSource.realmGet$downloadUploadStat());
        realmObjectTarget.realmSet$metadata(realmObjectSource.realmGet$metadata());
        realmObjectTarget.realmSet$voiceMessageSeen(realmObjectSource.realmGet$voiceMessageSeen());
        realmObjectTarget.realmSet$mediaDuration(realmObjectSource.realmGet$mediaDuration());
        realmObjectTarget.realmSet$thumb(realmObjectSource.realmGet$thumb());
        realmObjectTarget.realmSet$isForwarded(realmObjectSource.realmGet$isForwarded());
        realmObjectTarget.realmSet$videoThumb(realmObjectSource.realmGet$videoThumb());
        realmObjectTarget.realmSet$fileSize(realmObjectSource.realmGet$fileSize());
        com.soundcode.chat.model.realms.RealmContact contactObj = realmObjectSource.realmGet$contact();
        if (contactObj == null) {
            realmObjectTarget.realmSet$contact(null);
        } else {
            com.soundcode.chat.model.realms.RealmContact cachecontact = (com.soundcode.chat.model.realms.RealmContact) cache.get(contactObj);
            if (cachecontact != null) {
                realmObjectTarget.realmSet$contact(cachecontact);
            } else {
                realmObjectTarget.realmSet$contact(com_soundcode_chat_model_realms_RealmContactRealmProxy.copyOrUpdate(realm, contactObj, true, cache));
            }
        }
        com.soundcode.chat.model.realms.RealmLocation locationObj = realmObjectSource.realmGet$location();
        if (locationObj == null) {
            realmObjectTarget.realmSet$location(null);
        } else {
            com.soundcode.chat.model.realms.RealmLocation cachelocation = (com.soundcode.chat.model.realms.RealmLocation) cache.get(locationObj);
            if (cachelocation != null) {
                realmObjectTarget.realmSet$location(cachelocation);
            } else {
                realmObjectTarget.realmSet$location(com_soundcode_chat_model_realms_RealmLocationRealmProxy.copyOrUpdate(realm, locationObj, true, cache));
            }
        }
        realmObjectTarget.realmSet$isGroup(realmObjectSource.realmGet$isGroup());
        realmObjectTarget.realmSet$isSeen(realmObjectSource.realmGet$isSeen());
        com.soundcode.chat.model.realms.QuotedMessage quotedMessageObj = realmObjectSource.realmGet$quotedMessage();
        if (quotedMessageObj == null) {
            realmObjectTarget.realmSet$quotedMessage(null);
        } else {
            com.soundcode.chat.model.realms.QuotedMessage cachequotedMessage = (com.soundcode.chat.model.realms.QuotedMessage) cache.get(quotedMessageObj);
            if (cachequotedMessage != null) {
                realmObjectTarget.realmSet$quotedMessage(cachequotedMessage);
            } else {
                realmObjectTarget.realmSet$quotedMessage(com_soundcode_chat_model_realms_QuotedMessageRealmProxy.copyOrUpdate(realm, quotedMessageObj, true, cache));
            }
        }
        return realmObject;
    }
